...
export class SessionController {
  ...
  async getStats(@CurrentApiKey() apiKey?: ApiKey): Promise<{
    ...
    // effectiveAllowedSessions (not the raw allowedSessions column) so a key also sees stats for
    // sessions it created but that aren't in its own explicit scope list — see api-key.entity.ts.
